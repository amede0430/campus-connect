# Generated by Django 4.2.11 on 2024-05-22 19:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(max_length=100, null=True)),
                ('university_type', models.CharField(max_length=50, null=True)),
                ...
                ('universite', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='adminpage.universite')),
